...
const SHOTS: Shot[] = [
  ...
  /* Station Plaza: every corner, the loop, the clock, and each way out. */
  { name: 'plaza, out on to the forecourt', area: 'station-plaza', x: -55, z: -10, facing: E, floor: 1.2 },
  { name: 'plaza, down the steps', area: 'station-plaza', x: -46, z: -10, facing: E },
  { name: 'plaza, the clock from the west', area: 'station-plaza', x: -20, z: 0, facing: E },
  { name: 'plaza, the clock from the east', area: 'station-plaza', x: 20, z: 0, facing: W },
  { name: 'plaza, the station front', area: 'station-plaza', x: 10, z: -10, facing: W },
  ...
  { name: 'plaza, the south-east corner', area: 'station-plaza', x: 56, z: 50, facing: SE },

  /* Domino Station: the way in, the length of the hall, the gate line, every
     platform, both ends of the shed, and the terrace it is all seen from. */
  { name: 'station, in at the arcade door', area: 'domino-station', x: -40, z: 40, facing: (Math.PI * 3) / 4 },
  { name: 'station, the lobby looking back', area: 'domino-station', x: -38, z: 38, facing: -(Math.PI * 3) / 4 },
  { name: 'station, down the hall', area: 'domino-station', x: -40, z: 26, facing: E },
  { name: 'station, the hall from the east end', area: 'domino-station', x: 42, z: 26, facing: W },
  { name: 'station, up at the gate line', area: 'domino-station', x: 0, z: 24, facing: N },
  { name: 'station, through the gates', area: 'domino-station', x: 0, z: 10, facing: N },
  { name: 'station, the cross passage', area: 'domino-station', x: -40, z: 11, facing: E },
  { name: 'station, platform one', area: 'domino-station', x: -38.4, z: -6, facing: N },
  { name: 'station, platform three', area: 'domino-station', x: 0, z: -6, facing: N },
  { name: 'station, platform five', area: 'domino-station', x: 38.4, z: -6, facing: N },
  { name: 'station, the empty road', area: 'domino-station', x: -13.4, z: -20, facing: E },
  { name: 'station, beside the train', area: 'domino-station', x: -26.1, z: -20, facing: W },
  ...
  { name: 'high, into the entrance hall', area: 'domino-high', x: 0, z: -54, facing: S },
  { name: 'high, the corridor, west end', area: 'domino-high', x: -68, z: -49.2, facing: E },
  { name: 'high, the corridor, east end', area: 'domino-high', x: 68, z: -49.2, facing: W },
  { name: 'high, the corridor, from the middle', area: 'domino-high', x: -40, z: -49.2, facing: E },
  { name: 'high, into a classroom', area: 'domino-high', x: -56.8, z: -48.6, facing: S },
  { name: 'high, at the foot of the stair', area: 'domino-high', x: -48, z: -60.8, facing: S },
  { name: 'high, out into the courtyard', area: 'domino-high', x: 0, z: -34, facing: S },
  { name: 'high, along the walkway', area: 'domino-high', x: -30, z: -30, facing: S },
  { name: 'high, the library door', area: 'domino-high', x: 0, z: -12, facing: S },
  { name: 'high, in the library', area: 'domino-high', x: 0, z: -2, facing: E },
  { name: 'high, across the field', area: 'domino-high', x: 10, z: 45, facing: W },
  { name: 'high, the far touchline', area: 'domino-high', x: -86, z: 45, facing: E },
  ...
  { name: 'high, the south-east corner', area: 'domino-high', x: 92, z: 76, facing: N },
  ...
  { name: 'the station gate, its north end', area: 'market-row', x: 18, z: -3.4, facing: E },
