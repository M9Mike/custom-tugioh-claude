...
interface Shot { name: string; area: AreaId; x: number; z: number; facing: number }
...
const SHOTS: Shot[] = [
  ...
  { name: 'square NW, the lane mouth', area: 'black-crown', x: -11, z: -13, facing: NW },
  { name: 'square SW', area: 'black-crown', x: -15, z: 9, facing: SW },
  ...
  { name: 'yard, the back wall', area: 'black-crown', x: -44, z: -1.5, facing: W },
  ...
  { name: 'court NW, under the pier', area: 'black-crown', x: 20, z: -14, facing: NW },
  { name: 'court NE', area: 'black-crown', x: 22, z: -14, facing: NE },
  ...
  { name: 'podium south, the terrace', area: 'black-crown', x: 13, z: 8, facing: S },

  /* And inside, where Mike could see out through the joints. */
  { name: 'shop NW from the mat', area: 'crown-shop', x: -8, z: -4, facing: NW },
  { name: 'shop NE', area: 'crown-shop', x: 8, z: -4, facing: NE },
  { name: 'shop SE, the counter corner', area: 'crown-shop', x: 8, z: 4, facing: SE },
  { name: 'shop SW', area: 'crown-shop', x: -8, z: 4, facing: SW },
  { name: 'shop, the front wall from inside', area: 'crown-shop', x: -6, z: 0, facing: W },
  { name: 'shop, the back wall', area: 'crown-shop', x: 6, z: 0, facing: E },
  { name: 'shop, up at the galleries', area: 'crown-shop', x: 0, z: 0, facing: N },
];
...
async function main() {
  ...
  for (const s of chosen) {
    ...
    await page.screenshot({ path: `/tmp/corners/${slug}.png`, timeout: 60000 });
